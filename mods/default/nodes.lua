...
engine.register_node("default:stone", {
	description = S("Stone"),
...
engine.register_node("default:cobble", {
...
engine.register_node("default:stonebrick", {
...
engine.register_node("default:stone_block", {
...
engine.register_node("default:mossycobble", {
...
engine.register_node("default:desert_stone", {
...
engine.register_node("default:desert_cobble", {
...
engine.register_node("default:desert_stonebrick", {
...
engine.register_node("default:desert_stone_block", {
...
engine.register_node("default:sandstone", {
...
engine.register_node("default:sandstonebrick", {
...
engine.register_node("default:sandstone_block", {
...
engine.register_node("default:desert_sandstone", {
...
engine.register_node("default:desert_sandstone_brick", {
...
engine.register_node("default:desert_sandstone_block", {
...
engine.register_node("default:silver_sandstone", {
...
engine.register_node("default:silver_sandstone_brick", {
...
engine.register_node("default:silver_sandstone_block", {
...
engine.register_node("default:obsidian", {
...
engine.register_node("default:obsidianbrick", {
...
engine.register_node("default:obsidian_block", {
...
engine.register_node("default:dirt_with_grass", {
...
engine.register_node("default:dirt_with_grass_footsteps", {
...
engine.register_node("default:dirt_with_dry_grass", {
...
engine.register_node("default:dirt_with_snow", {
...
engine.register_node("default:dirt_with_rainforest_litter", {
...
engine.register_node("default:dirt_with_coniferous_litter", {
...
engine.register_node("default:dry_dirt", {
...
engine.register_node("default:dry_dirt_with_dry_grass", {
...
engine.register_node("default:permafrost", {
...
engine.register_node("default:permafrost_with_stones", {
...
engine.register_node("default:permafrost_with_moss", {
...
engine.register_node("default:sand", {
	description = S("Sand"),
...
engine.register_node("default:desert_sand", {
...
engine.register_node("default:silver_sand", {
...
engine.register_node("default:gravel", {
...
engine.register_node("default:clay", {
	description = S("Clay"),
...
engine.register_node("default:snow", {
	...
	on_construct = function(pos)
		pos.y = pos.y - 1
		if engine.get_node(pos).name == "default:dirt_with_grass" then
			engine.set_node(pos, {name = "default:dirt_with_snow"})
		end
	end,
})

engine.register_node("default:snowblock", {
...
engine.register_node("default:ice", {
	description = S("Ice"),
...
engine.register_node("default:cave_ice", {
...
engine.register_node("default:tree", {
...
engine.register_node("default:wood", {
...
engine.register_node("default:sapling", {
	...
	on_construct = function(pos)
		engine.get_node_timer(pos):start(math.random(300, 1500))
	end,
...
engine.register_node("default:leaves", {
...
engine.register_node("default:apple", {
	description = S("Apple"),
	drawtype = "plantlike",
	waving = 1,
	...
	after_place_node = function(pos, placer, itemstack)
		engine.set_node(pos, {name = "default:apple", param2 = 1})
	end,

	after_dig_node = function(pos, oldnode, oldmetadata, digger)
		if oldnode.param2 == 0 then
			engine.set_node(pos, {name = "default:apple_mark"})
			engine.get_node_timer(pos):start(math.random(300, 1500))
		end
	end,
})

engine.register_node("default:apple_mark", {
	...
	on_timer = function(pos, elapsed)
		if not engine.find_node_near(pos, 1, "default:leaves") then
			engine.remove_node(pos)
		elseif engine.get_node_light(pos) < 11 then
			engine.get_node_timer(pos):start(200)
		else
			engine.set_node(pos, {name = "default:apple"})
		end
	end
})
...
engine.register_node("default:emergent_jungle_sapling", {
...
engine.register_node("default:pine_tree", {
...
engine.register_node("default:pine_wood", {
...
engine.register_node("default:pine_needles",{
...
engine.register_node("default:pine_sapling", {
...
engine.register_node("default:acacia_tree", {
...
engine.register_node("default:acacia_wood", {
...
engine.register_node("default:acacia_leaves", {
...
engine.register_node("default:acacia_sapling", {
...
engine.register_node("default:aspen_tree", {
...
engine.register_node("default:aspen_wood", {
...
engine.register_node("default:aspen_leaves", {
...
engine.register_node("default:aspen_sapling", {
...
engine.register_node("default:stone_with_coal", {
...
engine.register_node("default:coalblock", {
...
engine.register_node("default:stone_with_iron", {
...
engine.register_node("default:ironblock", {
...
engine.register_node("default:steelblock", {
...
engine.register_node("default:stone_with_copper", {
...
engine.register_node("default:copperblock", {
...
engine.register_node("default:stone_with_tin", {
...
engine.register_node("default:tinblock", {
...
engine.register_node("default:bronzeblock", {
...
engine.register_node("default:stone_with_mese", {
...
engine.register_node("default:mese", {
...
engine.register_node("default:stone_with_gold", {
...
engine.register_node("default:goldblock", {
...
engine.register_node("default:stone_with_diamond", {
...
engine.register_node("default:diamondblock", {
...
engine.register_node("default:cactus", {
...
engine.register_node("default:large_cactus_seedling", {
	...
	on_construct = function(pos)
		...
		engine.get_node_timer(pos):start(math.random(1859, 3719))
	end,

	on_timer = function(pos)
		local node_under = engine.get_node_or_nil(
			{x = pos.x, y = pos.y - 1, z = pos.z})
		if not node_under then
			-- Node under not yet loaded, try later
			engine.get_node_timer(pos):start(300)
			return
		end

		if engine.get_item_group(node_under.name, "sand") == 0 then
			-- Seedling dies
			engine.remove_node(pos)
			return
		end

		local light_level = engine.get_node_light(pos)
		...
		engine.log("action", "A large cactus seedling grows into a large" ..
			"cactus at ".. engine.pos_to_string(pos))
		default.grow_large_cactus(pos)
	end,
})

engine.register_node("default:papyrus", {
...
engine.register_node("default:dry_shrub", {
...
engine.register_node("default:junglegrass", {
	...
	walkable = false,
	buildable_to = true,
	groups = {snappy = 3, flora = 1, attached_node = 1, grass = 1, junglegrass = 1, flammable = 1, dig_immediate = 3},
	sounds = default.node_sound_leaves_defaults(),
	selection_box = {
		type = "fixed",
		fixed = {-6 / 16, -0.5, -6 / 16, 6 / 16, 0.5, 6 / 16},
...
engine.register_node("default:grass_1", {
	description = S("Grass"),
	drawtype = "plantlike",
	waving = 1,
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		local ret = engine.item_place(stack, placer, pointed_thing)
...
for i = 2, 5 do
	engine.register_node("default:grass_" .. i, {
		description = S("Grass"),
		drawtype = "plantlike",
		waving = 1,
...
engine.register_node("default:dry_grass_1", {
...
for i = 2, 5 do
	engine.register_node("default:dry_grass_" .. i, {
		description = S("Savanna Grass"),
		drawtype = "plantlike",
		waving = 1,
...
engine.register_node("default:fern_1", {
	description = S("Fern"),
	drawtype = "plantlike",
	waving = 1,
...
for i = 2, 3 do
	engine.register_node("default:fern_" .. i, {
		description = S("Fern"),
		drawtype = "plantlike",
		waving = 1,
		visual_scale = 2,
...
engine.register_node("default:marram_grass_1", {
...
for i = 2, 3 do
	engine.register_node("default:marram_grass_" .. i, {
		description = S("Marram Grass"),
		drawtype = "plantlike",
		waving = 1,
...
engine.register_node("default:bush_stem", {
...
engine.register_node("default:bush_leaves", {
...
engine.register_node("default:bush_sapling", {
...
engine.register_node("default:blueberry_bush_leaves_with_berries", {
	...
	after_dig_node = function(pos, oldnode, oldmetadata, digger)
		engine.set_node(pos, {name = "default:blueberry_bush_leaves"})
		engine.get_node_timer(pos):start(math.random(300, 1500))
	end,
})

engine.register_node("default:blueberry_bush_leaves", {
	...
	on_timer = function(pos, elapsed)
		if engine.get_node_light(pos) < 11 then
			...
			engine.set_node(pos, {name = "default:blueberry_bush_leaves_with_berries"})
		end
	end,
...
engine.register_node("default:blueberry_bush_sapling", {
...
engine.register_node("default:acacia_bush_stem", {
...
engine.register_node("default:acacia_bush_leaves", {
...
engine.register_node("default:acacia_bush_sapling", {
...
engine.register_node("default:pine_bush_stem", {
...
engine.register_node("default:pine_bush_needles", {
...
engine.register_node("default:pine_bush_sapling", {
...
engine.register_node("default:sand_with_kelp", {
	description = S("Kelp"),
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		if pointed_thing.type == "node" and placer and
			...
			local node_ptu = engine.get_node(pointed_thing.under)
			local def_ptu = engine.registered_nodes[node_ptu.name]
		...
		if engine.get_node(pos).name ~= "default:sand" then
			return itemstack
		end

		local height = math.random(4, 6)
		local pos_top = {x = pos.x, y = pos.y + height, z = pos.z}
		local node_top = engine.get_node(pos_top)
		local def_top = engine.registered_nodes[node_top.name]
		local player_name = placer:get_player_name()

		if def_top and def_top.liquidtype == "source" and
				engine.get_item_group(node_top.name, "water") > 0 then
			if not engine.is_protected(pos, player_name) and
					not engine.is_protected(pos_top, player_name) then
				engine.set_node(pos, {name = "default:sand_with_kelp",
					param2 = height * 16})
	...
	after_destruct  = function(pos, oldnode)
		engine.set_node(pos, {name = "default:sand"})
	end
})
...
local function coral_on_place(itemstack, placer, pointed_thing)
	...
	local node_under = engine.get_node(pos_under)
	local def_under = engine.registered_nodes[node_under.name]
	...
	if node_under.name ~= "default:coral_skeleton" or
			engine.get_node(pos_above).name ~= "default:water_source" then
		return itemstack
	end

	if engine.is_protected(pos_under, player_name) or
			engine.is_protected(pos_above, player_name) then
		default.log_player_action(placer,
			"tried to place", itemstack:get_name(),
			"at protected position", pos_under)
		engine.record_protection_violation(pos_under, player_name)
		return itemstack
	end

	node_under.name = itemstack:get_name()
	engine.set_node(pos_under, node_under)
	if not engine.is_creative_enabled(player_name) then
		itemstack:take_item()
	end
...
engine.register_node("default:coral_green", {
	...
	after_destruct  = function(pos, oldnode)
		engine.set_node(pos, {name = "default:coral_skeleton"})
	end,
})

engine.register_node("default:coral_pink", {
...
engine.register_node("default:coral_cyan", {
...
engine.register_node("default:coral_brown", {
...
engine.register_node("default:coral_orange", {
...
engine.register_node("default:coral_skeleton", {
...
engine.register_node("default:water_source", {
...
engine.register_node("default:water_flowing", {
...
engine.register_node("default:river_water_source", {
...
engine.register_node("default:river_water_flowing", {
...
engine.register_node("default:lava_source", {
...
engine.register_node("default:lava_flowing", {
...
local function register_sign(material, desc, def)
	engine.register_node("default:sign_wall_" .. material, {
		description = desc,
		drawtype = "nodebox",
...
engine.register_node("default:ladder_wood", {
...
engine.register_node("default:ladder_steel", {
...
engine.register_node("default:glass", {
	description = S("Glass"),
...
engine.register_node("default:obsidian_glass", {
...
engine.register_node("default:brick", {
...
engine.register_node("default:meselamp", {
...
engine.register_node("default:cloud", {
	description = S("Cloud"),
...
if engine.get_mapgen_setting("mg_name") == "v6" then
