...
local theme_inv = [[
		image[0,8;1,1;gui_hb_bg.png]
		image[1,8;1,1;gui_hb_bg.png]
		image[2,8;1,1;gui_hb_bg.png]
		image[3,8;1,1;gui_hb_bg.png]
		image[4,8;1,1;gui_hb_bg.png]
		image[5,8;1,1;gui_hb_bg.png]
		image[6,8;1,1;gui_hb_bg.png]
		image[7,8;1,1;gui_hb_bg.png]
		image[8,8;1,1;gui_hb_bg.png]
...
function sfinv.get_formspec(player, context)
	...
	if page then
		...
		if old_page == home_page then
			engine.log("error", "[sfinv] Couldn't find " .. dump(old_page) ..
		...
		engine.log("warning", "[sfinv] Couldn't find " .. dump(old_page) ..
