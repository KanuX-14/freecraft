...
local stuff_string = engine.settings:get("initial_stuff") or
...
if engine.settings:get_bool("give_initial_stuff") then
	engine.register_on_newplayer(give_initial_stuff.give)
end
