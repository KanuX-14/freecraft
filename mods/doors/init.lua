...
doors.register("door_wood", {
    ...
    groups = {node = 1, choppy = 2, oddly_breakable_by_hand = 2, flammable = 2, notop = 1},
    gain_open = 0.06,
    gain_close = 0.13,
    recipe = {
...
doors.register("door_steel", {
    ...
    protected = true,
    groups = {node = 1, cracky = 1, level = 2, notop = 1},
...
doors.register("door_glass", {
    ...
    groups = {node = 1, cracky=3, oddly_breakable_by_hand=3, notop = 1},
...
doors.register("door_obsidian_glass", {
    ...
    groups = {node = 1, cracky=3, notop = 1},
    sounds = default.node_sound_glass_defaults(),
    sound_open = "doors_glass_door_open",
    sound_close = "doors_glass_door_close",
    gain_open = 0.3,
...
doors.register_fencegate("doors:gate_junglewood", {
  ...
  texture = "default_jungle_wood.png",
