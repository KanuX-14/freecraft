...
function boat.on_detach_child(self, child)
	entity_api.detach_child(self, child)
end

function boat.on_activate(self, staticdata, dtime_s)
	entity_api.activate(self, staticdata, dtime_s)
end


function boat.get_staticdata(self)
	return entity_api.get_staticdata(self)
end
...
minetest.register_craftitem("entity_api:boat", {
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		if not entity_api.is_water(pointed_thing.under) then
			return itemstack
		end
