...
local S = engine.get_translator("map")
...
function map.update_hud_flags(player)
  local creative_enabled = engine.is_creative_enabled(player:get_player_name())
...
local function cyclic_update()
  ...
  engine.after(5.3, cyclic_update)
end
...
engine.register_craftitem("map:mapping_kit", {
